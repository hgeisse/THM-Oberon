...
int main(int argc, char *argv[]) {
  ...
  while (run) {
    ...
    switch (b) {
      case 0x00:
        printf("write bytes, read bytes: ok\n");
        break;
      case 0x80:
        printf("write bytes, read bytes: failed\n");
        break;
      case 0x01:
        printf("write bytes, read words: ok\n");
        break;
      case 0x81:
        printf("write bytes, read words: failed\n");
        break;
      case 0x02:
        printf("write words, read bytes: ok\n");
        break;
      case 0x82:
        printf("write words, read bytes: failed\n");
        break;
      case 0x03:
        printf("write words, read words: ok\n");
        break;
      case 0x83:
